...
fn valid_decimal_source(frames: usize) -> String {
    format!(
        "import std.string;\n\
         ...
         \x20       match string.to_float(\"1.25\") {{\n\
