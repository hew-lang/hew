; ModuleID = 'ffi_borrow_boundary'
source_filename = "ffi_borrow_boundary"
...
declare ptr @ffi_borrow_get()

declare i64 @ffi_borrow_read(ptr)

define internal i64 @read_foreign() {
entry:
...
bb0:                                              ; preds = %after_cooperate
  %call_result = call ptr @ffi_borrow_get()
...
bb1:                                              ; preds = %bb0
  ...
  %move_load1 = load ptr, ptr %local_1, align 4
  store ptr %move_load1, ptr %local_2, align 4
  %call_arg = load ptr, ptr %local_2, align 4
  %call_result2 = call i64 @ffi_borrow_read(ptr %call_arg)
...
bb2:                                              ; preds = %bb1
  ...
  store i64 %move_load4, ptr %return_slot, align 8
...
bb0:                                              ; preds = %after_cooperate
  %call_result = call i64 @read_foreign()
  store i64 %call_result, ptr %local_0, align 8
  br label %bb1

bb1:                                              ; preds = %bb0
  %print_arg = load i64, ptr %local_0, align 8
