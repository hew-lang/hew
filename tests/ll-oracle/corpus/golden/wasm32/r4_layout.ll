...
helper_crash_cleanup_deactivate_merge:            ; preds = %helper_crash_cleanup_deactivate_accepted, %bb5
  ...
  %arm_typed_crash_cleanup = call i64 @hew_cont_crash_cleanup_arm(i64 %helper_crash_cleanup_prior_token, ptr %local_9, i64 4, i64 4, ptr @__hew_frame_cleanup_0, i32 1, i32 0)
...
helper_crash_cleanup_deactivate_merge16:          ; preds = %helper_crash_cleanup_deactivate_accepted19, %bb11
  ...
  %arm_typed_crash_cleanup23 = call i64 @hew_cont_crash_cleanup_arm(i64 %helper_crash_cleanup_prior_token22, ptr %local_23, i64 4, i64 4, ptr @__hew_frame_cleanup_1, i32 1, i32 0)
