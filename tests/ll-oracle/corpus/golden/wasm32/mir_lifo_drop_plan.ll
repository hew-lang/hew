...
helper_crash_cleanup_deactivate_merge:            ; preds = %helper_crash_cleanup_deactivate_accepted, %bb0
  ...
  %arm_typed_crash_cleanup = call i64 @hew_cont_crash_cleanup_arm(i64 %helper_crash_cleanup_prior_token, ptr %local_3, i64 4, i64 4, ptr @__hew_frame_cleanup_0, i32 1, i32 0)
...
helper_crash_cleanup_deactivate_merge6:           ; preds = %helper_crash_cleanup_deactivate_accepted9, %frame_cleanup_registered
  ...
  %arm_typed_crash_cleanup13 = call i64 @hew_cont_crash_cleanup_arm(i64 %helper_crash_cleanup_prior_token12, ptr %local_7, i64 4, i64 4, ptr @__hew_frame_cleanup_0, i32 1, i32 0)
...
helper_crash_cleanup_deactivate_merge22:          ; preds = %helper_crash_cleanup_deactivate_accepted25, %frame_cleanup_registered15
  ...
  %arm_typed_crash_cleanup29 = call i64 @hew_cont_crash_cleanup_arm(i64 %helper_crash_cleanup_prior_token28, ptr %local_11, i64 4, i64 4, ptr @__hew_frame_cleanup_0, i32 1, i32 0)
