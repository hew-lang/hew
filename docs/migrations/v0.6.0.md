...
The nonblocking `net.try_read`, `net.try_read_string`, `channel.try_recv`, and
`channel.try_send` operations remain distinct APIs; this migration does not rename them.
