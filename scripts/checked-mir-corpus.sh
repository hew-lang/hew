#!/usr/bin/env bash
# Runtime corpus driver for examples/v05/checked-mir/.
#
# Textual raw/elaborated MIR is pinned by the `checked_mir_snapshots` Rust
# integration test. Keeping snapshot comparison there gives ordinary tests a
# fail-closed oracle and gives intentional changes the standard insta review
# flow, without maintaining a second manifest and stale-file detector here.
#
