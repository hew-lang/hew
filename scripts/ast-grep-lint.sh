...
python3 scripts/tests/test_no_leaf_name_join_rule.py "$AST_GREP"
python3 scripts/tests/test_no_format_symbol_rule.py "$AST_GREP"
python3 scripts/tests/test_no_builtin_name_literal_decision_rule.py "$AST_GREP"
