...
use crate::resume::sched_enqueue;
...
impl ActivationMetricsGuard {
    fn new() -> Self {
        crate::scheduler::ACTIVE_WORKERS.fetch_add(1, Ordering::Relaxed);
        Self
    }
}
impl Drop for ActivationMetricsGuard {
    fn drop(&mut self) {
        crate::scheduler::ACTIVE_WORKERS.fetch_sub(1, Ordering::Relaxed);
        crate::scheduler::TASKS_COMPLETED.fetch_add(1, Ordering::Relaxed);
    }
}
#[cfg(any(test, debug_assertions))]
