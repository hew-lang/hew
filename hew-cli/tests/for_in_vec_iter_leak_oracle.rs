...
fn hashset_owned_field_loop_source(frames: usize) -> String {
    format!(
        "type SetBox {{ words: HashSet<string> }}\n\
         \n\
         fn make_box() -> SetBox {{\n\
         \x20   var words: HashSet<string> = HashSet.new();\n\
...
fn nested_vec_full_drain_loop_source(frames: usize) -> String {
    format!(
        "fn main() -> i64 {{\n\
         ...
         \x20   var i: i64 = 0;\n\
         \x20   while i < {frames} {{\n\
         \x20       var rows: Vec<Vec<string>> = Vec.new();\n\
         \x20       var r: i64 = 0;\n\
         \x20       while r < 8 {{\n\
         \x20           var row: Vec<string> = Vec.new();\n\
...
fn nested_hashmap_full_drain_loop_source(frames: usize) -> String {
    format!(
        "fn main() -> i64 {{\n\
         ...
         \x20   var i: i64 = 0;\n\
         \x20   while i < {frames} {{\n\
         \x20       var maps: Vec<HashMap<string, i64>> = Vec.new();\n\
         \x20       var map: HashMap<string, i64> = HashMap.new();\n\
...
fn nested_hashset_full_drain_loop_source(frames: usize) -> String {
    format!(
        "fn main() -> i64 {{\n\
         ...
         \x20   var i: i64 = 0;\n\
         \x20   while i < {frames} {{\n\
         \x20       var sets: Vec<HashSet<string>> = Vec.new();\n\
         \x20       var set: HashSet<string> = HashSet.new();\n\
...
fn tuple_string_full_drain_loop_source(frames: usize) -> String {
    format!(
        "fn main() -> i64 {{\n\
         ...
         \x20   var i: i64 = 0;\n\
         \x20   while i < {frames} {{\n\
         \x20       var pairs: Vec<(string, string)> = Vec.new();\n\
...
fn main() {\n\
\x20   var vv: Vec<Vec<string>> = Vec.new();\n\
\x20   var row: Vec<string> = Vec.new();\n\
\x20   row.push(\"escape\" + \"-alpha\");\n\
\x20   row.push(\"escape\" + \"-beta\");\n\
\x20   vv.push(row);\n\
\x20   var sink: HashMap<i64, Vec<string>> = HashMap.new();\n\
\x20   var k: i64 = 0;\n\
...
fn main() {\n\
\x20   var vm: Vec<HashMap<string, i64>> = Vec.new();\n\
\x20   var m: HashMap<string, i64> = HashMap.new();\n\
\x20   m.insert(\"escape\" + \"-key\", 7);\n\
\x20   vm.push(m);\n\
\x20   var sink: HashMap<i64, HashMap<string, i64>> = HashMap.new();\n\
\x20   var k: i64 = 0;\n\
...
fn main() {\n\
\x20   var vs: Vec<HashSet<string>> = Vec.new();\n\
\x20   var s: HashSet<string> = HashSet.new();\n\
\x20   s.insert(\"escape\" + \"-member\");\n\
\x20   vs.push(s);\n\
\x20   var sink: HashMap<i64, HashSet<string>> = HashMap.new();\n\
\x20   var k: i64 = 0;\n\
...
fn main() {\n\
\x20   var words: Vec<string> = Vec.new();\n\
\x20   words.push(\"a\" + \"1\");\n\
\x20   words.push(\"b\" + \"2\");\n\
...
\x20   var collected: Vec<Item> = Vec.new();\n\
\x20   for it in v.iter() {\n\
...
\x20   var sink: HashMap<i64, Item> = HashMap.new();\n\
\x20   var k: i64 = 0;\n\
\x20   for it in v.iter() {\n\
...
\x20   vv.push(row);\n\
\x20   var row2: Vec<string> = Vec.new();\n\
