...
pub use model::{
    ...
    ty_contains_unclonable_opaque_with_names, validate_context_markers, ActorHandlerLayout,
    ActorLayout, BasicBlock, BlockKind, BorrowKind, CaptureKind, CheckedMirFunction, ChildInitArg,
    ClosureEnvMode, CmpPred, CooperateKind, CooperateSite, CoroutineSchema, DecisionFact,
    Direction, DropFnSpec, DropKind, DropPlan, DynVtableInstance, ElabBlock, ElabDrop,
