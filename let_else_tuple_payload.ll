; ModuleID = 'let_else_tuple_payload'
source_filename = "let_else_tuple_payload"
target datalayout = "e-m:o-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-n32:64-S128-Fn32"
target triple = "aarch64-apple-macosx13.0"

%"Result$$tuple$xi64$cstring$g$string" = type { i8, [2 x i64] }
%"Result$$string$string" = type { i8, [1 x i64] }
%CrashInfo = type { i64, ptr }

@str_lit = private unnamed_addr constant [8 x i8] c"payload\00", align 1
@str_lit.1 = private unnamed_addr constant [8 x i8] c"no-pair\00", align 1
@str_lit.2 = private unnamed_addr constant [9 x i8] c"fallback\00", align 1
@str_lit.3 = private unnamed_addr constant [2 x i8] c":\00", align 1
@str_lit.4 = private unnamed_addr constant [4 x i8] c"ok=\00", align 1
@str_lit.5 = private unnamed_addr constant [5 x i8] c"err=\00", align 1
...
define internal %"Result$$tuple$xi64$cstring$g$string" @make_pair(i8 %0) {
entry:
  %return_slot = alloca %"Result$$tuple$xi64$cstring$g$string", align 8
  %local_0 = alloca i8, align 1
  %local_1 = alloca %"Result$$tuple$xi64$cstring$g$string", align 8
  %local_2 = alloca %"Result$$tuple$xi64$cstring$g$string", align 8
  %local_3 = alloca i64, align 8
  %local_4 = alloca i64, align 8
  %local_5 = alloca ptr, align 8
  %local_6 = alloca { i64, ptr }, align 8
  %local_7 = alloca %"Result$$tuple$xi64$cstring$g$string", align 8
  %local_8 = alloca %"Result$$tuple$xi64$cstring$g$string", align 8
  %local_9 = alloca i64, align 8
  %local_10 = alloca ptr, align 8
  %local_11 = alloca %"Result$$tuple$xi64$cstring$g$string", align 8
  store i8 %0, ptr %local_0, align 1
  br label %bb0

bb0:                                              ; preds = %entry
  %cond_load = load i8, ptr %local_0, align 1
  %cond_nz = icmp ne i8 %cond_load, 0
  br i1 %cond_nz, label %bb1, label %bb2

bb1:                                              ; preds = %bb0
  store i64 0, ptr %local_3, align 8
  %machine_tag_ptr = getelementptr inbounds nuw %"Result$$tuple$xi64$cstring$g$string", ptr %local_2, i32 0, i32 0
  ...
  store i64 7, ptr %local_4, align 8
  store ptr @str_lit, ptr %local_5, align 8
  %tuple_elem_0_load = load i64, ptr %local_4, align 8
  %tuple_elem_0_gep = getelementptr inbounds nuw { i64, ptr }, ptr %local_6, i32 0, i32 0
  store i64 %tuple_elem_0_load, ptr %tuple_elem_0_gep, align 8
  %tuple_elem_1_load = load ptr, ptr %local_5, align 8
  %tuple_elem_1_gep = getelementptr inbounds nuw { i64, ptr }, ptr %local_6, i32 0, i32 1
  store ptr %tuple_elem_1_load, ptr %tuple_elem_1_gep, align 8
  %machine_payload_ptr = getelementptr inbounds nuw %"Result$$tuple$xi64$cstring$g$string", ptr %local_2, i32 0, i32 1
  %machine_variant_field_ptr = getelementptr inbounds nuw { { i64, ptr } }, ptr %machine_payload_ptr, i32 0, i32 0
  %move_load = load { i64, ptr }, ptr %local_6, align 8
  store { i64, ptr } %move_load, ptr %machine_variant_field_ptr, align 8
  %move_load1 = load %"Result$$tuple$xi64$cstring$g$string", ptr %local_2, align 8
  store %"Result$$tuple$xi64$cstring$g$string" %move_load1, ptr %local_7, align 8
  %move_load2 = load %"Result$$tuple$xi64$cstring$g$string", ptr %local_7, align 8
  store %"Result$$tuple$xi64$cstring$g$string" %move_load2, ptr %local_1, align 8
  br label %bb3

bb2:                                              ; preds = %bb0
  store i64 1, ptr %local_9, align 8
  %machine_tag_ptr3 = getelementptr inbounds nuw %"Result$$tuple$xi64$cstring$g$string", ptr %local_8, i32 0, i32 0
  %move_iN_load_wide4 = load i64, ptr %local_9, align 8
  ...
  %machine_payload_ptr6 = getelementptr inbounds nuw %"Result$$tuple$xi64$cstring$g$string", ptr %local_8, i32 0, i32 1
  %machine_variant_field_ptr7 = getelementptr inbounds nuw { ptr }, ptr %machine_payload_ptr6, i32 0, i32 0
  %move_load8 = load ptr, ptr %local_10, align 8
  store ptr %move_load8, ptr %machine_variant_field_ptr7, align 8
  %move_load9 = load %"Result$$tuple$xi64$cstring$g$string", ptr %local_8, align 8
  store %"Result$$tuple$xi64$cstring$g$string" %move_load9, ptr %local_11, align 8
  %move_load10 = load %"Result$$tuple$xi64$cstring$g$string", ptr %local_11, align 8
  store %"Result$$tuple$xi64$cstring$g$string" %move_load10, ptr %local_1, align 8
  br label %bb3

bb3:                                              ; preds = %bb2, %bb1
  %move_load11 = load %"Result$$tuple$xi64$cstring$g$string", ptr %local_1, align 8
  store %"Result$$tuple$xi64$cstring$g$string" %move_load11, ptr %return_slot, align 8
  %ret_val = load %"Result$$tuple$xi64$cstring$g$string", ptr %return_slot, align 8
  ret %"Result$$tuple$xi64$cstring$g$string" %ret_val
}

define internal %"Result$$string$string" @parse(i8 %0) {
entry:
  %return_slot = alloca %"Result$$string$string", align 8
  %local_0 = alloca i8, align 1
  %local_1 = alloca %"Result$$tuple$xi64$cstring$g$string", align 8
  %local_2 = alloca i64, align 8
  %local_3 = alloca i64, align 8
  %local_4 = alloca i8, align 1
  %local_5 = alloca { i64, ptr }, align 8
  %local_6 = alloca { i64, ptr }, align 8
  %local_7 = alloca i64, align 8
  %local_8 = alloca i64, align 8
  %local_9 = alloca ptr, align 8
  %local_10 = alloca ptr, align 8
  %local_11 = alloca %"Result$$string$string", align 8
  ...
  %local_18 = alloca %"Result$$string$string", align 8
...
bb0:                                              ; preds = %after_cooperate
  ...
  %call_result = call %"Result$$tuple$xi64$cstring$g$string" @make_pair(i8 %call_arg)
  store %"Result$$tuple$xi64$cstring$g$string" %call_result, ptr %local_1, align 8
  br label %bb1

bb1:                                              ; preds = %bb0
  %machine_tag_ptr = getelementptr inbounds nuw %"Result$$tuple$xi64$cstring$g$string", ptr %local_1, i32 0, i32 0
...
bb2:                                              ; preds = %bb1
  %machine_payload_ptr = getelementptr inbounds nuw %"Result$$tuple$xi64$cstring$g$string", ptr %local_1, i32 0, i32 1
  %machine_variant_field_ptr = getelementptr inbounds nuw { { i64, ptr } }, ptr %machine_payload_ptr, i32 0, i32 0
  %move_load = load { i64, ptr }, ptr %machine_variant_field_ptr, align 8
  store { i64, ptr } %move_load, ptr %local_5, align 8
  %move_load1 = load { i64, ptr }, ptr %local_5, align 8
  store { i64, ptr } %move_load1, ptr %local_6, align 8
  %tuple_0_load_ptr = getelementptr inbounds nuw { i64, ptr }, ptr %local_6, i32 0, i32 0
  %tuple_0_load = load i64, ptr %tuple_0_load_ptr, align 8
  store i64 %tuple_0_load, ptr %local_7, align 8
  %move_load2 = load i64, ptr %local_7, align 8
  store i64 %move_load2, ptr %local_8, align 8
  %tuple_1_load_ptr = getelementptr inbounds nuw { i64, ptr }, ptr %local_6, i32 0, i32 1
  %tuple_1_load = load ptr, ptr %tuple_1_load_ptr, align 8
  %tuple_1_str_retain = call ptr @hew_string_clone(ptr %tuple_1_load)
  store ptr %tuple_1_str_retain, ptr %local_9, align 8
  %move_load3 = load ptr, ptr %local_9, align 8
  store ptr %move_load3, ptr %local_10, align 8
  br label %bb4

bb3:                                              ; preds = %bb1
  store i64 1, ptr %local_12, align 8
  %machine_tag_ptr4 = getelementptr inbounds nuw %"Result$$string$string", ptr %local_11, i32 0, i32 0
  %move_iN_load_wide = load i64, ptr %local_12, align 8
  %move_iN_trunc = trunc i64 %move_iN_load_wide to i8
  store i8 %move_iN_trunc, ptr %machine_tag_ptr4, align 1
  store ptr @str_lit.2, ptr %local_13, align 8
  %machine_payload_ptr5 = getelementptr inbounds nuw %"Result$$string$string", ptr %local_11, i32 0, i32 1
  %machine_variant_field_ptr6 = getelementptr inbounds nuw { ptr }, ptr %machine_payload_ptr5, i32 0, i32 0
  %move_load7 = load ptr, ptr %local_13, align 8
  store ptr %move_load7, ptr %machine_variant_field_ptr6, align 8
  %move_load8 = load %"Result$$string$string", ptr %local_11, align 8
  store %"Result$$string$string" %move_load8, ptr %return_slot, align 8
  %ret_val = load %"Result$$string$string", ptr %return_slot, align 8
  ret %"Result$$string$string" %ret_val

bb4:                                              ; preds = %after_cooperate14, %bb2
  store i64 35, ptr %local_14, align 8
  ...
  %cond_load9 = load i8, ptr %local_16, align 1
  %cond_nz10 = icmp ne i8 %cond_load9, 0
  br i1 %cond_nz10, label %bb6, label %bb7
...
bb6:                                              ; preds = %bb4
  %"hew_string_drop drop" = load ptr, ptr %local_10, align 8
...
bb7:                                              ; preds = %bb4
  %move_load15 = load i64, ptr %local_15, align 8
  store i64 %move_load15, ptr %local_17, align 8
  store i64 0, ptr %local_19, align 8
  %machine_tag_ptr16 = getelementptr inbounds nuw %"Result$$string$string", ptr %local_18, i32 0, i32 0
  %move_iN_load_wide17 = load i64, ptr %local_19, align 8
  ...
  %call_result20 = call ptr @"string::fmt"(ptr %call_arg19)
  store ptr %call_result20, ptr %local_20, align 8
  br label %bb8

bb8:                                              ; preds = %bb7
  store ptr @str_lit.3, ptr %local_21, align 8
  %call_arg21 = load ptr, ptr %local_20, align 8
  %call_arg22 = load ptr, ptr %local_21, align 8
  %call_result23 = call ptr @hew_string_concat(ptr %call_arg21, ptr %call_arg22)
  store ptr %call_result23, ptr %local_22, align 8
  br label %bb9

bb9:                                              ; preds = %bb8
  %"hew_string_drop drop24" = load ptr, ptr %local_20, align 8
  call void @hew_string_drop(ptr %"hew_string_drop drop24")
  store ptr null, ptr %local_20, align 8
  %call_arg25 = load i64, ptr %local_17, align 8
  %call_result26 = call ptr @hew_i64_to_string(i64 %call_arg25)
  store ptr %call_result26, ptr %local_23, align 8
  br label %bb10

bb10:                                             ; preds = %bb9
  %call_arg27 = load ptr, ptr %local_22, align 8
  %call_arg28 = load ptr, ptr %local_23, align 8
  %call_result29 = call ptr @hew_string_concat(ptr %call_arg27, ptr %call_arg28)
  store ptr %call_result29, ptr %local_24, align 8
  br label %bb11

bb11:                                             ; preds = %bb10
  %"hew_string_drop drop30" = load ptr, ptr %local_23, align 8
  call void @hew_string_drop(ptr %"hew_string_drop drop30")
  store ptr null, ptr %local_23, align 8
  %"hew_string_drop drop31" = load ptr, ptr %local_22, align 8
  call void @hew_string_drop(ptr %"hew_string_drop drop31")
  store ptr null, ptr %local_22, align 8
  %machine_payload_ptr32 = getelementptr inbounds nuw %"Result$$string$string", ptr %local_18, i32 0, i32 1
  %machine_variant_field_ptr33 = getelementptr inbounds nuw { ptr }, ptr %machine_payload_ptr32, i32 0, i32 0
  %move_load34 = load ptr, ptr %local_24, align 8
  store ptr %move_load34, ptr %machine_variant_field_ptr33, align 8
  %move_load35 = load %"Result$$string$string", ptr %local_18, align 8
  store %"Result$$string$string" %move_load35, ptr %return_slot, align 8
  %"hew_string_drop drop36" = load ptr, ptr %local_10, align 8
  call void @hew_string_drop(ptr %"hew_string_drop drop36")
  store ptr null, ptr %local_10, align 8
  %ret_val37 = load %"Result$$string$string", ptr %return_slot, align 8
  ret %"Result$$string$string" %ret_val37

cancel_exit:                                      ; preds = %entry
  ret %"Result$$string$string" zeroinitializer

after_cooperate:                                  ; preds = %entry
  br label %bb0

cancel_exit13:                                    ; preds = %bb5
  ret %"Result$$string$string" zeroinitializer

after_cooperate14:                                ; preds = %bb5
  br label %bb4
}

define internal ptr @run(i8 %0) {
entry:
  %return_slot = alloca ptr, align 8
  %local_0 = alloca i8, align 1
  %local_1 = alloca ptr, align 8
  %local_2 = alloca %"Result$$string$string", align 8
  %local_3 = alloca i64, align 8
  %local_4 = alloca i64, align 8
...
bb0:                                              ; preds = %after_cooperate
  %call_arg = load i8, ptr %local_0, align 1
  %call_result = call %"Result$$string$string" @parse(i8 %call_arg)
  store %"Result$$string$string" %call_result, ptr %local_2, align 8
  br label %bb1

bb1:                                              ; preds = %bb0
  %machine_tag_ptr = getelementptr inbounds nuw %"Result$$string$string", ptr %local_2, i32 0, i32 0
  %move_iN_load = load i8, ptr %machine_tag_ptr, align 1
  %move_iN_zext = zext i8 %move_iN_load to i64
...
bb2:                                              ; preds = %after_cooperate31, %after_cooperate22
...
bb3:                                              ; preds = %bb1
  %machine_payload_ptr = getelementptr inbounds nuw %"Result$$string$string", ptr %local_2, i32 0, i32 1
  ...
  store ptr @str_lit.4, ptr %local_9, align 8
  %call_arg2 = load ptr, ptr %local_8, align 8
  %call_result3 = call ptr @"string::fmt"(ptr %call_arg2)
  store ptr %call_result3, ptr %local_10, align 8
  br label %bb7

bb4:                                              ; preds = %bb6
  %machine_payload_ptr4 = getelementptr inbounds nuw %"Result$$string$string", ptr %local_2, i32 0, i32 1
  %machine_variant_field_ptr5 = getelementptr inbounds nuw { ptr }, ptr %machine_payload_ptr4, i32 0, i32 0
  %move_load6 = load ptr, ptr %machine_variant_field_ptr5, align 8
  store ptr %move_load6, ptr %local_12, align 8
  store ptr @str_lit.5, ptr %local_13, align 8
  %call_arg7 = load ptr, ptr %local_12, align 8
  %call_result8 = call ptr @"string::fmt"(ptr %call_arg7)
  store ptr %call_result8, ptr %local_14, align 8
  br label %bb9
...
bb6:                                              ; preds = %bb1
  ...
  %cmp_lhs9 = load i64, ptr %local_3, align 8
  %cmp_rhs10 = load i64, ptr %local_6, align 8
  %cmp_bit11 = icmp eq i64 %cmp_lhs9, %cmp_rhs10
  %cmp_zext12 = zext i1 %cmp_bit11 to i8
  store i8 %cmp_zext12, ptr %local_7, align 1
  %cond_load13 = load i8, ptr %local_7, align 1
  %cond_nz14 = icmp ne i8 %cond_load13, 0
  br i1 %cond_nz14, label %bb4, label %bb5

bb7:                                              ; preds = %bb3
  %call_arg15 = load ptr, ptr %local_9, align 8
  %call_arg16 = load ptr, ptr %local_10, align 8
  %call_result17 = call ptr @hew_string_concat(ptr %call_arg15, ptr %call_arg16)
  store ptr %call_result17, ptr %local_11, align 8
  br label %bb8
...
bb8:                                              ; preds = %bb7
  ...
  call void @hew_string_drop(ptr %"hew_string_drop drop")
  store ptr null, ptr %local_10, align 8
  %move_load18 = load ptr, ptr %local_11, align 8
  store ptr %move_load18, ptr %local_1, align 8
...
bb9:                                              ; preds = %bb4
  %call_arg23 = load ptr, ptr %local_13, align 8
  %call_arg24 = load ptr, ptr %local_14, align 8
  %call_result25 = call ptr @hew_string_concat(ptr %call_arg23, ptr %call_arg24)
  store ptr %call_result25, ptr %local_15, align 8
  br label %bb10

bb10:                                             ; preds = %bb9
  %"hew_string_drop drop26" = load ptr, ptr %local_14, align 8
  call void @hew_string_drop(ptr %"hew_string_drop drop26")
  store ptr null, ptr %local_14, align 8
  %move_load27 = load ptr, ptr %local_15, align 8
  store ptr %move_load27, ptr %local_1, align 8
...
bb0:                                              ; preds = %after_cooperate
  ...
  %call_arg = load i8, ptr %local_0, align 1
  %call_result = call ptr @run(i8 %call_arg)
  store ptr %call_result, ptr %local_1, align 8
  br label %bb1

bb1:                                              ; preds = %bb0
  %print_arg = load ptr, ptr %local_1, align 8
...
bb2:                                              ; preds = %bb1
  ...
  %call_arg1 = load i8, ptr %local_2, align 1
  %call_result2 = call ptr @run(i8 %call_arg1)
  store ptr %call_result2, ptr %local_3, align 8
  br label %bb3

bb3:                                              ; preds = %bb2
  %print_arg3 = load ptr, ptr %local_3, align 8
  %print_str_bits4 = ptrtoint ptr %print_arg3 to i64
  call void @hew_print_value(i8 4, i64 %print_str_bits4, i1 true)
  br label %bb4

bb4:                                              ; preds = %bb3
  %"hew_string_drop drop5" = load ptr, ptr %local_3, align 8
  call void @hew_string_drop(ptr %"hew_string_drop drop5")
