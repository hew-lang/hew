...
entry:
  ...
  store { ptr, i32, i32 } %0, ptr %local_0, align 8
...
bb1:                                              ; preds = %bb0
  %call_arg1 = load { ptr, i32, i32 }, ptr %local_1, align 8
  %call_result2 = call i64 @byte_count({ ptr, i32, i32 } %call_arg1)
  store i64 %call_result2, ptr %local_2, align 8
  br label %bb2
