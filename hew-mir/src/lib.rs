...
pub use model::{
    ...
    Direction, DropKind, DropPlan, DynVtableInstance, ElabBlock, ElabDrop, ElaboratedMirFunction,
    EnumLayout, ExitPath, FieldOffset, FloatWidth, FunctionCallConv, GenStateDropTable,
    GenStateLayout, GenStateLiveLocal, Instr, IntArithOp, IntSignedness, IrPipeline, LambdaCapture,
