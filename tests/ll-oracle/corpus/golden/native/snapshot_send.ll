; ModuleID = 'snapshot_send'
source_filename = "snapshot_send"
...
entry:
  ...
  store %Boxed %1, ptr %local_0, align 8
...
bb0:                                              ; preds = %borrow_escape_ok
  ...
  store ptr %field_0_load, ptr %local_2, align 8
...
bb1:                                              ; preds = %bb0
  %field_0_load_ptr2 = getelementptr inbounds nuw %Boxed, ptr %local_0, i32 0, i32 0
  %field_0_load3 = load ptr, ptr %field_0_load_ptr2, align 8
  store ptr %field_0_load3, ptr %local_3, align 8
  store i64 0, ptr %local_4, align 8
  %"hew_vec_len arg0" = load ptr, ptr %local_3, align 8
...
bb3:                                              ; preds = %bb1
  %"hew_vec_get_i64 arg0" = load ptr, ptr %local_3, align 8
  %"hew_vec_get_i64 arg1" = load i64, ptr %local_4, align 8
  %hew_vec_get_i64_call = call i64 @hew_vec_get_i64(ptr %"hew_vec_get_i64 arg0", i64 %"hew_vec_get_i64 arg1")
  store i64 %hew_vec_get_i64_call, ptr %local_7, align 8
  store i64 10000, ptr %local_8, align 8
  %checked_lhs = load i64, ptr %local_7, align 8
...
bb5:                                              ; preds = %bb3
  ...
  %field_0_load27 = load ptr, ptr %field_0_load_ptr26, align 8
  store ptr %field_0_load27, ptr %local_11, align 8
  store i64 1, ptr %local_12, align 8
  %"hew_vec_len arg028" = load ptr, ptr %local_11, align 8
...
bb7:                                              ; preds = %bb5
  %"hew_vec_get_i64 arg046" = load ptr, ptr %local_11, align 8
...
bb11:                                             ; preds = %bb9
  ...
  %field_0_load86 = load ptr, ptr %field_0_load_ptr85, align 8
  store ptr %field_0_load86, ptr %local_21, align 8
  store i64 2, ptr %local_22, align 8
  %"hew_vec_len arg087" = load ptr, ptr %local_21, align 8
...
bb13:                                             ; preds = %bb11
  %"hew_vec_get_i64 arg0105" = load ptr, ptr %local_21, align 8
...
helper_crash_cleanup_guard_live:                  ; preds = %entry
  ...
  %arm_typed_crash_cleanup = call i64 @hew_cont_crash_cleanup_arm(i64 %helper_crash_cleanup_prior_token, ptr %local_0, i64 8, i64 8, ptr @__hew_frame_cleanup_cd3565128175cb7f, i32 1, i32 0)
...
entry:
  ...
  %local_11 = alloca %Boxed, align 8
  %local_12 = alloca %Boxed, align 8
  %local_13 = alloca i64, align 8
  %local_14 = alloca %__hew_packed_args_main_0, align 8
  %local_15 = alloca i64, align 8
  %local_16 = alloca %__hew_packed_args_main_1, align 8
...
bb0:                                              ; preds = %after_cooperate
  ...
  store ptr @str_actor_meta_handler_Sink_0_take, ptr %actor_meta_handler_0_f0, align 8
  ...
  store ptr @str_actor_meta_name_Sink, ptr %actor_meta_f0, align 8
  ...
  %hew_actor_spawn_call = call ptr @hew_actor_spawn(ptr %local_0, i64 ptrtoint (ptr getelementptr (%Sink, ptr null, i32 1) to i64), ptr @__hew_actor_dispatch_Sink)
  ...
  store ptr @str_actor_meta_handler_Sink_0_take, ptr %actor_meta_handler_0_f06, align 8
  ...
  store ptr null, ptr %actor_meta_handler_0_f39, align 8
  %actor_meta_handler_0_f410 = getelementptr inbounds nuw { ptr, i32, i32, ptr, ptr, i32 }, ptr %actor_meta_handler_05, i32 0, i32 4
  store ptr null, ptr %actor_meta_handler_0_f410, align 8
  ...
  store ptr @str_actor_meta_name_Sink, ptr %actor_meta_f014, align 8
  ...
  store ptr %actor_meta_handlers_ptr12, ptr %actor_meta_f216, align 8
  call void @hew_wasm_register_actor_meta(ptr %actor_meta_Sink13)
  call void @hew_actor_register_type(ptr @__hew_actor_dispatch_Sink, ptr @str_actor_type_name_Sink)
  call void @hew_register_handler_name(ptr @__hew_actor_dispatch_Sink, i32 1476289385, ptr @str_actor_handler_name_Sink_0_take)
  %hew_actor_spawn_call17 = call ptr @hew_actor_spawn(ptr %local_3, i64 ptrtoint (ptr getelementptr (%Sink, ptr null, i32 1) to i64), ptr @__hew_actor_dispatch_Sink)
  ...
  store ptr %hew_actor_spawn_call17, ptr %local_5, align 8
  %hew_vec_new_i64_call = call ptr @hew_vec_new_i64()
  store ptr %hew_vec_new_i64_call, ptr %local_6, align 8
  br label %bb1

bb1:                                              ; preds = %bb0
  %move_load = load ptr, ptr %local_6, align 8
  store ptr %move_load, ptr %local_7, align 8
  store i64 1, ptr %local_8, align 8
  %call_arg = load ptr, ptr %local_7, align 8
  %call_arg18 = load i64, ptr %local_8, align 8
  call void @hew_vec_push_i64(ptr %call_arg, i64 %call_arg18)
  br label %bb2

bb2:                                              ; preds = %bb1
  store i64 2, ptr %local_9, align 8
  %call_arg19 = load ptr, ptr %local_7, align 8
  %call_arg20 = load i64, ptr %local_9, align 8
  call void @hew_vec_push_i64(ptr %call_arg19, i64 %call_arg20)
  br label %bb3

bb3:                                              ; preds = %bb2
  %move_load21 = load ptr, ptr %local_7, align 8
  store ptr %move_load21, ptr %local_10, align 8
  %field_0_init_ptr22 = getelementptr inbounds nuw %Boxed, ptr %local_11, i32 0, i32 0
  %field_0_init_src23 = load ptr, ptr %local_10, align 8
  store ptr %field_0_init_src23, ptr %field_0_init_ptr22, align 8
...
bb5:                                              ; preds = %clone_ok29
  ...
  %call_arg41 = load ptr, ptr %local_17, align 8
...
helper_crash_cleanup_deactivate_merge:            ; preds = %helper_crash_cleanup_deactivate_accepted, %bb3
  %move_load24 = load %Boxed, ptr %local_11, align 8
  store %Boxed %move_load24, ptr %local_12, align 8
  %helper_crash_cleanup_prior_token = load i64, ptr %helper_crash_cleanup_token_12, align 8
  %arm_typed_crash_cleanup = call i64 @hew_cont_crash_cleanup_arm(i64 %helper_crash_cleanup_prior_token, ptr %local_12, i64 8, i64 8, ptr @__hew_frame_cleanup_cd3565128175cb7f, i32 1, i32 0)
  %frame_cleanup_arm_failed = icmp eq i64 %arm_typed_crash_cleanup, -1
  br i1 %frame_cleanup_arm_failed, label %frame_cleanup_rejected, label %frame_cleanup_registered
...
frame_cleanup_registered:                         ; preds = %helper_crash_cleanup_deactivate_merge
  ...
  call void @llvm.memcpy.p0.p0.i64(ptr align 8 %local_19, ptr align 8 %local_12, i64 8, i1 false)
...
clone_ok:                                         ; preds = %frame_cleanup_registered
  ...
  %field_0_init_src26 = load %Boxed, ptr %local_19, align 8
  store %Boxed %field_0_init_src26, ptr %field_0_init_ptr25, align 8
  %field_1_init_ptr = getelementptr inbounds nuw %__hew_packed_args_main_0, ptr %local_14, i32 0, i32 1
  %field_1_init_src = load i64, ptr %local_13, align 8
  ...
  %hew_actor_send_by_id_call = call i32 @hew_actor_send_by_id(i64 %actor_id, ptr null, i32 1476289385, ptr %local_14, i64 ptrtoint (ptr getelementptr (%__hew_packed_args_main_0, ptr null, i32 1) to i64))
...
clone_ok29:                                       ; preds = %bb4
  %field_0_init_ptr31 = getelementptr inbounds nuw %__hew_packed_args_main_1, ptr %local_16, i32 0, i32 0
  %field_0_init_src32 = load %Boxed, ptr %local_20, align 8
  store %Boxed %field_0_init_src32, ptr %field_0_init_ptr31, align 8
  %field_1_init_ptr33 = getelementptr inbounds nuw %__hew_packed_args_main_1, ptr %local_16, i32 0, i32 1
  %field_1_init_src34 = load i64, ptr %local_15, align 8
  store i64 %field_1_init_src34, ptr %field_1_init_ptr33, align 8
  %"actor_send receiver35" = load ptr, ptr %local_5, align 8
  %actor_id_slot36 = getelementptr i8, ptr %"actor_send receiver35", i64 8
  %actor_id37 = load i64, ptr %actor_id_slot36, align 8
  %hew_actor_send_by_id_call38 = call i32 @hew_actor_send_by_id(i64 %actor_id37, ptr null, i32 1476289385, ptr %local_16, i64 ptrtoint (ptr getelementptr (%__hew_packed_args_main_1, ptr null, i32 1) to i64))
...
hew_shutdown_exit_failed:                         ; preds = %helper_crash_cleanup_return_merge_12
  call void @hew_exit(i64 1)
  br label %hew_shutdown_exit_continue

hew_shutdown_exit_continue:                       ; preds = %hew_shutdown_exit_failed, %helper_crash_cleanup_return_merge_12
  ret i8 0
}
...
define internal ptr @__hew_actor_dispatch_Sink(ptr %0, ptr %1, i32 %2, ptr %3, i64 %4, i32 %5) {
entry:
...
msg_1476289385:                                   ; preds = %payload_src
  ...
  %msg_arg_0 = load %Boxed, ptr %msg_arg_0_ptr, align 8
...
define internal void @__hew_actor_sys_dispatch_Sink(ptr %0, ptr %1, i32 %2, ptr %3, i64 %4) {
entry:
...
sys_exit_guard:                                   ; preds = %entry
  %sys_payload_big_enough = icmp uge i64 %4, ptrtoint (ptr getelementptr ({ i64, i32, i32 }, ptr null, i32 1) to i64)
...
sys_down_guard:                                   ; preds = %entry
  %sys_payload_big_enough1 = icmp uge i64 %4, ptrtoint (ptr getelementptr ({ i64, i32, i32, i64, i64, i64, i32, i32 }, ptr null, i32 1) to i64)
...
define internal void @__hew_message_drop_Sink(i32 %0, ptr %1, i64 %2) {
entry:
...
step_0_store:                                     ; preds = %step_0_clone
  %dst_f0_ptr = getelementptr inbounds nuw %Boxed, ptr %1, i32 0, i32 0
  store ptr %clone_helper_f0, ptr %dst_f0_ptr, align 8
  br label %success

step_0_clone:                                     ; preds = %entry
  %src_f0_ptr = getelementptr inbounds nuw %Boxed, ptr %0, i32 0, i32 0
...
entry:
  ...
  %ow_new_d0_f0_ptr = getelementptr inbounds nuw %Boxed, ptr %1, i32 0, i32 0
  %ow_new_d0_f0_leaf = load ptr, ptr %ow_new_d0_f0_ptr, align 8
  store ptr %ow_new_d0_f0_leaf, ptr %ow_slot_0, align 8
  %ow_old_d0_f0_ptr = getelementptr inbounds nuw %Boxed, ptr %0, i32 0, i32 0
