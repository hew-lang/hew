...
bb3:                                              ; preds = %frame_cleanup_registered23
  %"hew_string_drop drop26" = load ptr, ptr %local_10, align 4
...
helper_crash_cleanup_deactivate_merge:            ; preds = %helper_crash_cleanup_deactivate_accepted, %bb1
  ...
  %arm_typed_crash_cleanup = call i64 @hew_cont_crash_cleanup_arm(i64 %helper_crash_cleanup_prior_token, ptr %local_1, i64 4, i64 4, ptr @__hew_frame_cleanup_231a5e1683e2486b, i32 1, i32 0)
...
helper_crash_cleanup_deactivate_merge14:          ; preds = %helper_crash_cleanup_deactivate_accepted17, %helper_crash_cleanup_deactivate_merge7
  %move_load19 = load %Bundle, ptr %local_8, align 4
  store %Bundle %move_load19, ptr %local_9, align 4
  %helper_crash_cleanup_prior_token20 = load i64, ptr %helper_crash_cleanup_token_9, align 8
  %arm_typed_crash_cleanup21 = call i64 @hew_cont_crash_cleanup_arm(i64 %helper_crash_cleanup_prior_token20, ptr %local_9, i64 8, i64 4, ptr @__hew_frame_cleanup_dd2698fd845d405b, i32 1, i32 0)
...
frame_cleanup_registered23:                       ; preds = %helper_crash_cleanup_deactivate_merge14
  ...
  %call_arg25 = load ptr, ptr %local_10, align 4
...
helper_crash_cleanup_retire_merge31:              ; preds = %helper_crash_cleanup_retire_accepted34, %helper_crash_cleanup_retire_merge
  %"hew_vec_free_owned drop" = load ptr, ptr %local_1, align 4
...
entry:
  %"hew_vec_free_owned drop" = load ptr, ptr %0, align 4
  call void @hew_vec_free_owned(ptr %"hew_vec_free_owned drop")
