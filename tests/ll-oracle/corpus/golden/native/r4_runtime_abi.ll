...
bb13:                                             ; preds = %bb8
  %call_arg32 = load ptr, ptr %local_1, align 8
...
bb16:                                             ; preds = %bb15
  %move_load36 = load ptr, ptr %local_19, align 8
  store ptr %move_load36, ptr %local_20, align 8
...
bb17:                                             ; preds = %insert_overwrite_key_cont
  ...
  %"hew_hashmap_insert_layout arg037" = load ptr, ptr %local_20, align 8
...
bb33:                                             ; preds = %bb34
  %"hew_hashmap_free_layout drop110" = load ptr, ptr %local_20, align 8
...
bb36:                                             ; preds = %bb35
  %move_load118 = load ptr, ptr %local_47, align 8
  store ptr %move_load118, ptr %local_48, align 8
...
bb37:                                             ; preds = %bb36
  ...
  %"hew_hashset_insert_layout arg0119" = load ptr, ptr %local_48, align 8
...
bb42:                                             ; preds = %bb41
  ...
  %move_load125 = load ptr, ptr %local_56, align 8
  store ptr %move_load125, ptr %local_57, align 8
  store ptr @str_lit.5, ptr %local_58, align 8
  %move_load126 = load ptr, ptr %local_58, align 8
  store ptr %move_load126, ptr %local_59, align 8
  ...
  %move_load127 = load ptr, ptr %local_60, align 8
  store ptr %move_load127, ptr %local_61, align 8
  %print_arg128 = load ptr, ptr %local_61, align 8
  %print_str_bits = ptrtoint ptr %print_arg128 to i64
  call void @hew_print_value(i8 4, i64 %print_str_bits, i1 true)
  br label %bb43

bb43:                                             ; preds = %bb42
  %call_arg129 = load ptr, ptr %local_61, align 8
...
insert_overwrite_key_release39:                   ; preds = %bb17
  %"hew_hashmap_insert_layout overwrite key42" = load ptr, ptr %local_23, align 8
...
cancel_exit75:                                    ; preds = %bb27
  %"hew_hashmap_free_layout drop77" = load ptr, ptr %local_20, align 8
  call void @hew_hashmap_free_layout(ptr %"hew_hashmap_free_layout drop77")
  store ptr null, ptr %local_20, align 8
  %"hew_vec_free drop78" = load ptr, ptr %local_1, align 8
...
cancel_exit81:                                    ; preds = %bb28
  %"hew_hashmap_free_layout drop83" = load ptr, ptr %local_20, align 8
  call void @hew_hashmap_free_layout(ptr %"hew_hashmap_free_layout drop83")
  store ptr null, ptr %local_20, align 8
  %"hew_vec_free drop84" = load ptr, ptr %local_1, align 8
...
cancel_exit99:                                    ; preds = %bb31
  %"hew_hashmap_free_layout drop101" = load ptr, ptr %local_20, align 8
...
cancel_exit106:                                   ; preds = %bb32
  %"hew_hashmap_free_layout drop108" = load ptr, ptr %local_20, align 8
  call void @hew_hashmap_free_layout(ptr %"hew_hashmap_free_layout drop108")
  store ptr null, ptr %local_20, align 8
  %"hew_vec_free drop109" = load ptr, ptr %local_1, align 8
