...
pub use check::{
    ...
    DynVtableEntry, DynVtableKey, EntryDisplayTarget, EntryExitAction, EntryExitPlan,
    EntryIntegerType, ExecutionContextReader, FnSig, HashMapMethod, HashSetMethod, ImplDef, ImplId,
    ImplRegistry, LintId, LintLevel, LintLevels, LintSources, LookupError, MachineMethodKind,
    MathGenericOp, MethodCallReceiverKind, MethodCallRewrite, MethodTarget, MethodTargetFamily,
    ...
    ResolvedCall, RuntimeAbi, SpanKey, TryConversionKind, TryWidthCastLowering, TyPattern,
    TypeCheckOutput, UserComparisonDispatch, VariantDef, VariantMatch, VecHigherOrderOp, VecMethod,
