...
pub use model::{
    ...
    ty_contains_heap_owning, validate_context_markers, ActorLayout, BasicBlock, BlockKind,
    BorrowKind, CaptureKind, CheckedMirFunction, ChildInitArg, CmpPred, CooperateKind,
    CooperateSite, CoroutineSchema, DecisionFact, Direction, DropKind, DropPlan, DynVtableInstance,
    ElabBlock, ElabDrop, ElaboratedMirFunction, EnumLayout, ExitPath, FieldOffset, FloatWidth,
...
pub use state_clone::{
    ...
    classify_owned_string_record_fields, classify_state_field,
    classify_state_field_with_enum_layouts, mangle_actor_state_clone_fn,
