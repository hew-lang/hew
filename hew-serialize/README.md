...
Serializes the type-checked AST into MessagePack format for consumption by Hew's embedded C++ MLIR code generator (`hew-codegen`). Also supports JSON output for debugging (`hew build --emit-json`).
