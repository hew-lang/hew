...
fn engine<'ctx>(llvm: &Module<'ctx>, optimized: bool) -> ExecutionEngine<'ctx> {
    ...
    bind!(
        ...
        coro_state::hew_coro_state_cleanup_child,
        coro_state::hew_coro_state_set_cleanup_fault,
        ...
        hashset::hew_hashset_free_layout_walk,
        ...
        vec::hew_vec_free_owned_walk,
        vec::hew_array_free,
        vec::hew_array_free_walk,
        vec::hew_vec_clone_owned,
        vec::hew_vec_push_owned,
        vec::hew_vec_push_owned_move,
        vec::hew_vec_set_owned,
        vec::hew_vec_set_owned_move,
        vec::hew_vec_set_owned_release,
        vec::hew_vec_set_owned_move_release,
        vec::hew_vec_clear_release,
        ...
        release_walker::hew_release_sync,
        release_walker::hew_release_next,
        release_walker::hew_release_layout,
        release_walker::hew_release_finish,
        release_walker::hew_vec_release_begin,
        release_walker::hew_array_release_begin,
        release_walker::hew_hashmap_release_begin,
        hashset::hew_hashset_release_begin,
        callable::hew_callable_release_begin,
        trait_object::hew_trait_object_release_begin,
        rc::hew_rc_release_begin,
        hashmap::hew_hashmap_clear_release,
        hashset::hew_hashset_clear_release,
        mailbox::hew_msg_envelope_release,
        fault::hew_fault_new,
        fault::hew_fault_code,
