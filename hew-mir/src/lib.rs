...
pub use model::{
    ...
    ElabBlock, ElabDrop, ElaboratedMirFunction, EnumLayout, ExitPath, ExternDecl, FieldAddr,
    FieldOffset, FloatWidth, FunctionCallConv, HeapOwnershipLayouts, Instr, IntArithOp,
