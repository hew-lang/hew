...
fn hir_kind_str(kind: &hew_hir::HirDiagnosticKind) -> &'static str {
    ...
    match kind {
        ...
        K::TuplePatternArityMismatch { .. } => "TuplePatternArityMismatch",
        K::TuplePatternNonTupleValue => "TuplePatternNonTupleValue",
        K::EnumVariantConstructorShapeMismatch { .. } => "EnumVariantConstructorShapeMismatch",
        K::EnumVariantConstructorMissingField { .. } => "EnumVariantConstructorMissingField",
        K::EnumVariantConstructorUnknownField { .. } => "EnumVariantConstructorUnknownField",
        K::EnumVariantConstructorArityMismatch { .. } => "EnumVariantConstructorArityMismatch",
        ...
        K::LinearConsumingMethodSourceUnsupported { .. } => {
