...
helper_crash_cleanup_guard_live:                  ; preds = %helper_crash_cleanup_deactivate_merge
  ...
  %arm_typed_crash_cleanup = call i64 @hew_cont_crash_cleanup_arm(i64 %helper_crash_cleanup_prior_token, ptr %local_2, i64 4, i64 4, ptr @__hew_frame_cleanup_0, i32 1, i32 0)
...
helper_crash_cleanup_guard_live11:                ; preds = %helper_crash_cleanup_deactivate_merge3
  ...
  %arm_typed_crash_cleanup14 = call i64 @hew_cont_crash_cleanup_arm(i64 %helper_crash_cleanup_prior_token13, ptr %local_5, i64 4, i64 4, ptr @__hew_frame_cleanup_0, i32 1, i32 0)
...
helper_crash_cleanup_guard_live30:                ; preds = %helper_crash_cleanup_deactivate_merge22
  ...
  %arm_typed_crash_cleanup33 = call i64 @hew_cont_crash_cleanup_arm(i64 %helper_crash_cleanup_prior_token32, ptr %local_8, i64 4, i64 4, ptr @__hew_frame_cleanup_1, i32 1, i32 0)
...
helper_crash_cleanup_guard_live49:                ; preds = %helper_crash_cleanup_deactivate_merge41
  ...
  %arm_typed_crash_cleanup52 = call i64 @hew_cont_crash_cleanup_arm(i64 %helper_crash_cleanup_prior_token51, ptr %local_11, i64 4, i64 4, ptr @__hew_frame_cleanup_1, i32 1, i32 0)
...
weak_upgrade_cont:                                ; preds = %weak_upgrade_none, %weak_upgrade_some
  ...
  %arm_typed_crash_cleanup167 = call i64 @hew_cont_crash_cleanup_arm(i64 %helper_crash_cleanup_prior_token166, ptr %local_29, i64 8, i64 4, ptr @__hew_frame_cleanup_2, i32 1, i32 0)
...
helper_crash_cleanup_guard_live:                  ; preds = %helper_crash_cleanup_deactivate_merge
  ...
  %arm_typed_crash_cleanup = call i64 @hew_cont_crash_cleanup_arm(i64 %helper_crash_cleanup_prior_token, ptr %local_1, i64 4, i64 4, ptr @__hew_frame_cleanup_1, i32 1, i32 0)
  %frame_cleanup_arm_failed = icmp eq i64 %arm_typed_crash_cleanup, -1
  br i1 %frame_cleanup_arm_failed, label %frame_cleanup_rejected, label %frame_cleanup_registered
...
weak_upgrade_cont:                                ; preds = %weak_upgrade_none, %weak_upgrade_some
  ...
  %arm_typed_crash_cleanup9 = call i64 @hew_cont_crash_cleanup_arm(i64 %helper_crash_cleanup_prior_token8, ptr %local_4, i64 8, i64 4, ptr @__hew_frame_cleanup_2, i32 1, i32 0)
