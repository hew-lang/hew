...
mod tests {
    ...
    fn local_lookup_returns_minus_one() {
        ...
        unsafe {
            ...
            let local_pid = (u64::from(7u16) << PID_SERIAL_BITS) | 0x002a;
    ...
    fn remote_route_lookup_and_remove() {
        ...
        unsafe {
            ...
            let remote_pid_a = (u64::from(9u16) << PID_SERIAL_BITS) | 0x0064;
            let remote_pid_b = (u64::from(10u16) << PID_SERIAL_BITS) | 0x00c8;
            let local_pid = (u64::from(1u16) << PID_SERIAL_BITS) | 0x0007;
