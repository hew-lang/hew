...
bb4:                                              ; preds = %bb3
  %"hew_vec_len arg0" = load ptr, ptr %local_1, align 8
...
bb6:                                              ; preds = %bb5
  ...
  %"hew_vec_get_clone arg0" = load ptr, ptr %local_1, align 8
...
bb13:                                             ; preds = %bb8
  %call_arg45 = load ptr, ptr %local_1, align 8
...
bb15:                                             ; preds = %bb14
  ...
  store ptr %hew_hashmap_new_with_layout_call, ptr %local_19, align 8
  br label %bb16
...
bb17:                                             ; preds = %insert_overwrite_key_cont
  store ptr @str_lit.1, ptr %local_23, align 8
  store i64 20, ptr %local_24, align 8
  %"hew_hashmap_insert_layout arg061" = load ptr, ptr %local_20, align 8
...
bb18:                                             ; preds = %insert_overwrite_key_cont64
  %"hew_hashmap_len_layout arg0" = load ptr, ptr %local_20, align 8
...
bb20:                                             ; preds = %bb19
  store ptr @str_lit.2, ptr %local_27, align 8
  %"hew_hashmap_get_layout arg0" = load ptr, ptr %local_20, align 8
...
bb22:                                             ; preds = %after_cooperate134, %after_cooperate114
  store ptr @str_lit.3, ptr %local_37, align 8
  %"hew_hashmap_remove_take_layout arg0" = load ptr, ptr %local_20, align 8
...
bb35:                                             ; preds = %bb30
  ...
  store ptr %hew_hashset_new_with_layout_call, ptr %local_47, align 8
  br label %bb36
...
bb37:                                             ; preds = %frame_cleanup_registered237
  ...
  %"hew_hashset_insert_layout arg0239" = load ptr, ptr %local_48, align 8
...
bb38:                                             ; preds = %bb37
  %"hew_hashset_len_layout arg0" = load ptr, ptr %local_48, align 8
...
bb40:                                             ; preds = %bb39
  ...
  %"hew_hashset_contains_layout arg0" = load ptr, ptr %local_48, align 8
...
bb42:                                             ; preds = %bb41
  store ptr @str_lit.4, ptr %local_56, align 8
...
bb43:                                             ; preds = %frame_cleanup_registered282
  %call_arg285 = load ptr, ptr %local_61, align 8
...
helper_crash_cleanup_deactivate_merge:            ; preds = %helper_crash_cleanup_deactivate_accepted, %bb1
  ...
  %arm_typed_crash_cleanup = call i64 @hew_cont_crash_cleanup_arm(i64 %helper_crash_cleanup_prior_token, ptr %local_1, i64 8, i64 8, ptr @__hew_frame_cleanup_7fdeddf79806b8a4, i32 1, i32 0)
...
helper_crash_cleanup_retire_merge25:              ; preds = %helper_crash_cleanup_retire_accepted28, %cancel_exit21
  %"hew_vec_free drop30" = load ptr, ptr %local_1, align 8
...
helper_crash_cleanup_deactivate_merge50:          ; preds = %helper_crash_cleanup_deactivate_accepted53, %bb16
  %move_load55 = load ptr, ptr %local_19, align 8
  store ptr %move_load55, ptr %local_20, align 8
  %helper_crash_cleanup_prior_token56 = load i64, ptr %helper_crash_cleanup_token_20, align 8
  %arm_typed_crash_cleanup57 = call i64 @hew_cont_crash_cleanup_arm(i64 %helper_crash_cleanup_prior_token56, ptr %local_20, i64 8, i64 8, ptr @__hew_frame_cleanup_01796e325d15e37f, i32 1, i32 0)
...
frame_cleanup_registered59:                       ; preds = %helper_crash_cleanup_deactivate_merge50
  ...
  store ptr @str_lit, ptr %local_21, align 8
  store i64 10, ptr %local_22, align 8
  %"hew_hashmap_insert_layout arg0" = load ptr, ptr %local_20, align 8
...
insert_overwrite_key_release:                     ; preds = %frame_cleanup_registered59
  %"hew_hashmap_insert_layout overwrite key" = load ptr, ptr %local_21, align 8
...
insert_overwrite_key_release63:                   ; preds = %bb17
  %"hew_hashmap_insert_layout overwrite key66" = load ptr, ptr %local_23, align 8
...
helper_crash_cleanup_retire_merge92:              ; preds = %helper_crash_cleanup_retire_accepted95, %bb25
  %"hew_hashmap_free_layout drop" = load ptr, ptr %local_20, align 8
...
helper_crash_cleanup_retire_merge99:              ; preds = %helper_crash_cleanup_retire_accepted102, %helper_crash_cleanup_retire_merge92
  %"hew_vec_free drop104" = load ptr, ptr %local_1, align 8
...
helper_crash_cleanup_retire_merge117:             ; preds = %helper_crash_cleanup_retire_accepted120, %cancel_exit113
  %"hew_hashmap_free_layout drop122" = load ptr, ptr %local_20, align 8
...
helper_crash_cleanup_retire_merge137:             ; preds = %helper_crash_cleanup_retire_accepted140, %cancel_exit133
  %"hew_hashmap_free_layout drop142" = load ptr, ptr %local_20, align 8
...
helper_crash_cleanup_retire_merge145:             ; preds = %helper_crash_cleanup_retire_accepted148, %helper_crash_cleanup_retire_merge137
  %"hew_vec_free drop150" = load ptr, ptr %local_1, align 8
...
helper_crash_cleanup_retire_merge169:             ; preds = %helper_crash_cleanup_retire_accepted172, %cancel_exit165
  %"hew_hashmap_free_layout drop174" = load ptr, ptr %local_20, align 8
...
helper_crash_cleanup_retire_merge177:             ; preds = %helper_crash_cleanup_retire_accepted180, %helper_crash_cleanup_retire_merge169
  %"hew_vec_free drop182" = load ptr, ptr %local_1, align 8
...
helper_crash_cleanup_retire_merge190:             ; preds = %helper_crash_cleanup_retire_accepted193, %cancel_exit186
  %"hew_hashmap_free_layout drop195" = load ptr, ptr %local_20, align 8
...
helper_crash_cleanup_retire_merge198:             ; preds = %helper_crash_cleanup_retire_accepted201, %helper_crash_cleanup_retire_merge190
  %"hew_vec_free drop203" = load ptr, ptr %local_1, align 8
...
helper_crash_cleanup_retire_merge206:             ; preds = %helper_crash_cleanup_retire_accepted209, %bb33
  %"hew_hashmap_free_layout drop211" = load ptr, ptr %local_20, align 8
...
helper_crash_cleanup_retire_merge214:             ; preds = %helper_crash_cleanup_retire_accepted217, %helper_crash_cleanup_retire_merge206
  %"hew_vec_free drop219" = load ptr, ptr %local_1, align 8
...
helper_crash_cleanup_deactivate_merge228:         ; preds = %helper_crash_cleanup_deactivate_accepted231, %bb36
  %move_load233 = load ptr, ptr %local_47, align 8
  store ptr %move_load233, ptr %local_48, align 8
  %helper_crash_cleanup_prior_token234 = load i64, ptr %helper_crash_cleanup_token_48, align 8
  %arm_typed_crash_cleanup235 = call i64 @hew_cont_crash_cleanup_arm(i64 %helper_crash_cleanup_prior_token234, ptr %local_48, i64 8, i64 8, ptr @__hew_frame_cleanup_5110292a480a33ee, i32 1, i32 0)
...
frame_cleanup_registered237:                      ; preds = %helper_crash_cleanup_deactivate_merge228
  ...
  %"hew_hashset_insert_layout arg0" = load ptr, ptr %local_48, align 8
...
helper_crash_cleanup_deactivate_merge247:         ; preds = %helper_crash_cleanup_deactivate_accepted250, %bb42
  %move_load252 = load ptr, ptr %local_56, align 8
  store ptr %move_load252, ptr %local_57, align 8
  %helper_crash_cleanup_prior_token253 = load i64, ptr %helper_crash_cleanup_token_57, align 8
  %arm_typed_crash_cleanup254 = call i64 @hew_cont_crash_cleanup_arm(i64 %helper_crash_cleanup_prior_token253, ptr %local_57, i64 8, i64 8, ptr @__hew_frame_cleanup_6e3157b8b1632579, i32 1, i32 0)
...
frame_cleanup_registered256:                      ; preds = %helper_crash_cleanup_deactivate_merge247
  ...
  store ptr @str_lit.5, ptr %local_58, align 8
...
helper_crash_cleanup_deactivate_merge260:         ; preds = %helper_crash_cleanup_deactivate_accepted263, %frame_cleanup_registered256
  %move_load265 = load ptr, ptr %local_58, align 8
  store ptr %move_load265, ptr %local_59, align 8
  %helper_crash_cleanup_prior_token266 = load i64, ptr %helper_crash_cleanup_token_59, align 8
  %arm_typed_crash_cleanup267 = call i64 @hew_cont_crash_cleanup_arm(i64 %helper_crash_cleanup_prior_token266, ptr %local_59, i64 8, i64 8, ptr @__hew_frame_cleanup_6e3157b8b1632579, i32 1, i32 0)
...
frame_cleanup_registered269:                      ; preds = %helper_crash_cleanup_deactivate_merge260
  ...
  %"hew_string_concat arg0" = load ptr, ptr %local_57, align 8
  %"hew_string_concat arg1" = load ptr, ptr %local_59, align 8
  %hew_string_concat_call = call ptr @hew_string_concat(ptr %"hew_string_concat arg0", ptr %"hew_string_concat arg1")
  store ptr %hew_string_concat_call, ptr %local_60, align 8
...
helper_crash_cleanup_deactivate_merge273:         ; preds = %helper_crash_cleanup_deactivate_accepted276, %frame_cleanup_registered269
  %move_load278 = load ptr, ptr %local_60, align 8
  store ptr %move_load278, ptr %local_61, align 8
  %helper_crash_cleanup_prior_token279 = load i64, ptr %helper_crash_cleanup_token_61, align 8
  %arm_typed_crash_cleanup280 = call i64 @hew_cont_crash_cleanup_arm(i64 %helper_crash_cleanup_prior_token279, ptr %local_61, i64 8, i64 8, ptr @__hew_frame_cleanup_6e3157b8b1632579, i32 1, i32 0)
...
frame_cleanup_registered282:                      ; preds = %helper_crash_cleanup_deactivate_merge273
  ...
  %print_arg284 = load ptr, ptr %local_61, align 8
...
helper_crash_cleanup_retire_merge297:             ; preds = %helper_crash_cleanup_retire_accepted300, %helper_crash_cleanup_retire_merge290
  %"hew_string_drop drop302" = load ptr, ptr %local_59, align 8
...
helper_crash_cleanup_retire_merge305:             ; preds = %helper_crash_cleanup_retire_accepted308, %helper_crash_cleanup_retire_merge297
  %"hew_string_drop drop310" = load ptr, ptr %local_57, align 8
...
helper_crash_cleanup_retire_merge320:             ; preds = %helper_crash_cleanup_retire_accepted323, %helper_crash_cleanup_retire_merge313
  %"hew_hashmap_free_layout drop325" = load ptr, ptr %local_20, align 8
...
helper_crash_cleanup_retire_merge328:             ; preds = %helper_crash_cleanup_retire_accepted331, %helper_crash_cleanup_retire_merge320
  %"hew_vec_free drop333" = load ptr, ptr %local_1, align 8
