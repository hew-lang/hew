...
helper_crash_cleanup_deactivate_merge:            ; preds = %helper_crash_cleanup_deactivate_accepted, %bb1
  ...
  %arm_typed_crash_cleanup = call i64 @hew_cont_crash_cleanup_arm(i64 %helper_crash_cleanup_prior_token, ptr %local_1, i64 8, i64 8, ptr @__hew_frame_cleanup_0, i32 1, i32 0)
...
helper_crash_cleanup_deactivate_merge50:          ; preds = %helper_crash_cleanup_deactivate_accepted53, %bb16
  ...
  %arm_typed_crash_cleanup57 = call i64 @hew_cont_crash_cleanup_arm(i64 %helper_crash_cleanup_prior_token56, ptr %local_20, i64 8, i64 8, ptr @__hew_frame_cleanup_1, i32 1, i32 0)
...
helper_crash_cleanup_deactivate_merge228:         ; preds = %helper_crash_cleanup_deactivate_accepted231, %bb36
  ...
  %arm_typed_crash_cleanup235 = call i64 @hew_cont_crash_cleanup_arm(i64 %helper_crash_cleanup_prior_token234, ptr %local_48, i64 8, i64 8, ptr @__hew_frame_cleanup_2, i32 1, i32 0)
...
helper_crash_cleanup_deactivate_merge247:         ; preds = %helper_crash_cleanup_deactivate_accepted250, %bb42
  ...
  %arm_typed_crash_cleanup254 = call i64 @hew_cont_crash_cleanup_arm(i64 %helper_crash_cleanup_prior_token253, ptr %local_57, i64 8, i64 8, ptr @__hew_frame_cleanup_3, i32 1, i32 0)
...
helper_crash_cleanup_deactivate_merge260:         ; preds = %helper_crash_cleanup_deactivate_accepted263, %frame_cleanup_registered256
  ...
  %arm_typed_crash_cleanup267 = call i64 @hew_cont_crash_cleanup_arm(i64 %helper_crash_cleanup_prior_token266, ptr %local_59, i64 8, i64 8, ptr @__hew_frame_cleanup_3, i32 1, i32 0)
...
helper_crash_cleanup_deactivate_merge273:         ; preds = %helper_crash_cleanup_deactivate_accepted276, %frame_cleanup_registered269
  ...
  %arm_typed_crash_cleanup280 = call i64 @hew_cont_crash_cleanup_arm(i64 %helper_crash_cleanup_prior_token279, ptr %local_61, i64 8, i64 8, ptr @__hew_frame_cleanup_3, i32 1, i32 0)
