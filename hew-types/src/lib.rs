...
pub use check::{
    ...
    PoolAccessorKind, RcIntrinsicOp, ReceiverUpdate, ResolvedCall, ResultReturnKind, RuntimeAbi,
    SpanKey, TryConversionKind, TryWidthCastLowering, TyPattern, TypeCheckOutput,
