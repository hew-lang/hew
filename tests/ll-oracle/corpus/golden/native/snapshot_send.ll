...
bb0:                                              ; preds = %after_cooperate
  ...
  store ptr @str_actor_meta_handler_TestSink_0_take, ptr %actor_meta_handler_0_f0, align 8
  ...
  store ptr @str_actor_meta_name_TestSink, ptr %actor_meta_f0, align 8
  ...
  %hew_actor_spawn_call = call ptr @hew_actor_spawn(ptr %local_0, i64 ptrtoint (ptr getelementptr (%TestSink, ptr null, i32 1) to i64), ptr @__hew_actor_dispatch_TestSink)
  ...
  store ptr @str_actor_meta_handler_TestSink_0_take, ptr %actor_meta_handler_0_f06, align 8
  ...
  store ptr @str_actor_meta_name_TestSink, ptr %actor_meta_f014, align 8
  ...
  call void @hew_actor_register_type(ptr @__hew_actor_dispatch_TestSink, ptr @str_actor_type_name_TestSink)
  call void @hew_register_handler_name(ptr @__hew_actor_dispatch_TestSink, i32 -1599914196, ptr @str_actor_handler_name_TestSink_0_take)
  %hew_actor_spawn_call17 = call ptr @hew_actor_spawn(ptr %local_3, i64 ptrtoint (ptr getelementptr (%TestSink, ptr null, i32 1) to i64), ptr @__hew_actor_dispatch_TestSink)
...
define internal ptr @__hew_actor_dispatch_TestSink(ptr %0, ptr %1, i32 %2, ptr %3, i64 %4, i32 %5) {
entry:
...
define internal void @__hew_actor_sys_dispatch_TestSink(ptr %0, ptr %1, i32 %2, ptr %3, i64 %4) {
entry:
...
define internal void @__hew_message_drop_TestSink(i32 %0, ptr %1, i64 %2) {
entry:
