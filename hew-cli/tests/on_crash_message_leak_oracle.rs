...
//!      42 is the declared init value: the supervisor rebuilds every
//!      incarnation from the declaration and its config, so the replacement
//!      never carries the dead instance's state.
