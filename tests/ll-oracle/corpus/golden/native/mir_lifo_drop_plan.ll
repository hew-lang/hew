...
bb0:                                              ; preds = %after_cooperate
  ...
  %move_load9 = load ptr, ptr %local_3, align 8
  store ptr %move_load9, ptr %local_20, align 8
  store ptr null, ptr %local_3, align 8
  %call_arg = load ptr, ptr %local_20, align 8
  %call_result = call i64 @measure(ptr %call_arg)
  store i64 %call_result, ptr %local_12, align 8
  br label %bb1

bb1:                                              ; preds = %bb0
  %move_load10 = load ptr, ptr %local_7, align 8
  store ptr %move_load10, ptr %local_21, align 8
  store ptr null, ptr %local_7, align 8
  %call_arg11 = load ptr, ptr %local_21, align 8
...
bb3:                                              ; preds = %bb2
  ...
  %"hew_string_drop drop13" = load ptr, ptr %local_7, align 8
  call void @hew_string_drop(ptr %"hew_string_drop drop13")
  store ptr null, ptr %local_7, align 8
  %"hew_string_drop drop14" = load ptr, ptr %local_3, align 8
...
bb4:                                              ; preds = %bb2
  %move_load15 = load ptr, ptr %local_11, align 8
  store ptr %move_load15, ptr %local_22, align 8
  store ptr null, ptr %local_11, align 8
  %call_arg16 = load ptr, ptr %local_22, align 8
...
bb6:                                              ; preds = %bb5
  %"hew_string_drop drop26" = load ptr, ptr %local_11, align 8
  call void @hew_string_drop(ptr %"hew_string_drop drop26")
  store ptr null, ptr %local_11, align 8
  %"hew_string_drop drop27" = load ptr, ptr %local_7, align 8
  call void @hew_string_drop(ptr %"hew_string_drop drop27")
  store ptr null, ptr %local_7, align 8
  %"hew_string_drop drop28" = load ptr, ptr %local_3, align 8
...
bb8:                                              ; preds = %bb7
  ...
  %"hew_string_drop drop31" = load ptr, ptr %local_11, align 8
  call void @hew_string_drop(ptr %"hew_string_drop drop31")
  store ptr null, ptr %local_11, align 8
  %"hew_string_drop drop32" = load ptr, ptr %local_7, align 8
  call void @hew_string_drop(ptr %"hew_string_drop drop32")
  store ptr null, ptr %local_7, align 8
  %"hew_string_drop drop33" = load ptr, ptr %local_3, align 8
