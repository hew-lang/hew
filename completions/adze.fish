...
complete -c adze -n "__fish_adze_using_subcommand init" -l bin -d 'Create a binary project'
...
complete -c adze -n "__fish_adze_using_subcommand namespace; and not __fish_seen_subcommand_from register list info help" -s h -l help -d 'Print help'
complete -c adze -n "__fish_adze_using_subcommand namespace; and not __fish_seen_subcommand_from register list info help" -f -a "register" -d 'Register a custom namespace prefix'
complete -c adze -n "__fish_adze_using_subcommand namespace; and not __fish_seen_subcommand_from register list info help" -f -a "list" -d 'List namespaces you own'
complete -c adze -n "__fish_adze_using_subcommand namespace; and not __fish_seen_subcommand_from register list info help" -f -a "info" -d 'Show info about a namespace'
complete -c adze -n "__fish_adze_using_subcommand namespace; and not __fish_seen_subcommand_from register list info help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c adze -n "__fish_adze_using_subcommand namespace; and __fish_seen_subcommand_from list" -s h -l help -d 'Print help'
...
complete -c adze -n "__fish_adze_using_subcommand namespace; and __fish_seen_subcommand_from help" -f -a "list" -d 'List namespaces you own'
...
complete -c adze -n "__fish_adze_using_subcommand help; and __fish_seen_subcommand_from namespace" -f -a "list" -d 'List namespaces you own'
