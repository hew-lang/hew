...
pub use model::{
    ...
    is_indirect_enum_for_ty, is_indirect_enum_layout_key, machine_enum_view, machine_enum_views,
    machine_event_enum_view, machine_event_enum_views, mangle_dyn_drop_in_place_symbol,
    ...
    MirCallableInstance, MirCallableKey, MirCheck, MirConst, MirConstValue, MirDiagnostic,
    MirDiagnosticKind, MirHeapLayouts, MirLint, MirScope, MirStatement, ModuleCapabilities,
    NeutralizeAuthority, OwnerId, OwnershipEvent, OwnershipGuardKind, ParamBoundaryFact,
    ParamBoundaryMode, ParamCrashCleanupKind, ParamLoanStorage, ParamRepresentationEffect, Place,
    PointerWidth, PolymorphicMirFunction, PoolCount, PreparedCarrierBoundary,
    ProjectedPayloadRejectReason, RawMirFunction, RawValueDef, RawValueId, RawValueOp,
